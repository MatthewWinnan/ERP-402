...
#define ACTIVE_ROUTE_TIMEOUT              2000  // Used during upper bound delete calculations
#define ALLOWED_HELLO_LOSS                5  // Number of hallo packet drops allowed. Make it one more than 
#define ALLOWED_R_ACK_LOSS          40 //Number of times sending retrying to receive an r_ack
#define HELLO_INTERVAL           2000  // If defined for node, this indicates how often hallo packets are sent to check links. Also sets the amount of delay between packets
#define TTL_START     1  // 
...
#define RERR_RATELIMIT  5
#define RING_TRAVERSAL_TIME 2 * NODE_TRAVERSAL_TIME *(TTL_VALUE + TIMEOUT_BUFFER)
#define RREQ_RATELIMIT  5
#define TIMEOUT_BUFFER  2 
#define QUEUE_BUFFER_TIME 200 //The maximum period of time that a routing protocol is allowed to buffer a packet for, milli-seconds
#define QUEUE_SIZE 10 //Defines the max amount to go to queue
#define QUEUE_TIMEOUT 200 //Expire time for queue entry
#define K_VALUE 5
#define DELETE_PERIOD K_VALUE * max (ACTIVE_ROUTE_TIMEOUT, HELLO_INTERVAL)
#define HELLO_TIME_OUT 3000
#define NEIGHBOUR_TIMEOUT 3000
//DEFINING THE EVENT FREQUENCIES IN MS
#define REQUEST_QUEUE_PERIOD 2000
#define MESSAGE_QUEUE_PERIOD 2000
#define M_BROADCAST_ID 40 //This is my broadcast ID for now
#define DUBLICATE_CACHE_TIMEOUT  1000
#define RREP_TIMEOUT 500
#define RRER_DEST_LIMIT 6 //limits the max size of destnumber in rrer packet
#define ENABLE_HALLO 1 //enables hallo packets
#define TX_NEXT_WAIT 2ms

//Define all timing requirements
#define HALLO_INTERVAL 1000ms
#define ROUTING_QUEUE_INTERVAL 2ms
#define MESSAGE_QUEUE_INTERVAL 1ms
#define RREQ_RATE_TIMER_INTERVAL 10ms
#define RRER_RATE_TIMER_INTERVAL 10ms
#define ROUTE_REQUEST_TIMER 50ms
#define PACKET_RATE 190ms

//Simulator timer
#define RESULTS_TIMER 1s
//Demo parameters
#define SHOW_MY_MESSAGE 0
...
#define SECRET_MESSAGE_ONE 6
#define SECRET_MESSAGE_TWO 7
#define SECRET_MESSAGE_THREE 8
#define SECRET_MESSAGE_FOUR 9
#define MESSAGE_TIME_ONE 10
#define MESSAGE_TIME_TWO 11
#define MESSAGE_TIME_THREE 12
#define MESSAGE_TIME_FOUR 13
